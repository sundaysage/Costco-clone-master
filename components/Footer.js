...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="md:hidden bg-neutral-200">
        {/* <!-- Footer Middle --> */}
          ...
          <div className="w-full mx-auto p-2">
            ...
            <div className="tab w-full overflow-hidden">
              ...
              <div className="label relative border-t border-gray-400 ">
                <label
                  className="block py-3 uppercase font-medium tracking-wide cursor-pointer"
        ...
        {/* <!-- Footer Bottom --> */}
        <div className="border-t border-gray-400 justify-center items-center p-6 mt-4 text-gray-600">
          <div className="flex w-100">
            <ul className="text-gray-700 list-none p-0 font-thin flex text-center justify-center flex-wrap w-full">
              <li>
                <Link
                  href="#"
                  className="inline-block  p-2 text-gray-500 hover:underline no-underline"
                >
                  Site Map{" "}
                </Link>
              </li>
          ...
          <div className="container flex flex-col md:flex-row justify-center items-center mx-auto">
            {/* <div className="social w-1/5 mx-5 my-5 flex flex-start">
              <Link
                className="block flex items-center text-gray-300 hover:underline mr-6 no-underline"
                href="#"
              >
                <svg
                  viewBox="0 0 24 24"
              ...
              <Link
                className="block flex items-center text-gray-300 hover:underline no-underline"
                href="#"
              >
                <svg
                  viewBox="0 0 24 24"
          ...
          <div className="flex flex-col md:flex-row border-gray-800 justify-center items-center p-6 mt-4 text-gray-600">
            <div>
              © 1998 — 2023 Costco Wholesale Corporation. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
      ...
      <footer className="hidden md:block bg-neutral-200">
        {/* <!-- Footer Top --> */}
          ...
          <div className=" overflow-hidden flex flex-col lg:flex-row mx-auto p-4">
            <div className="container block md:flex text-sm mt-6 lg:mt-0">
              ...
              <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li className="inline-block py-3 uppercase font-medium tracking-wide">
                  Customer Service
                </li>
                <li>
                  <Link
